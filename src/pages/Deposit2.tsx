...
const Deposit2 = () => {
  const handlePayment = () => {
    window.open("https://buy.stripe.com/5kQ14mgFF4cv4dM5NLes009", "_blank");
  };
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            <p className="text-lg font-semibold mb-2">Deposit: HKD$200</p>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 space-y-2">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>This deposit is non-refundable as it reserves your seat. The remaining balance of HKD$1,800 must be paid on the event day at the venue.</p>
              </div>
            </div>
          </div>
