...
const Deposit = () => {
  const handlePayment = () => {
    window.open("https://buy.stripe.com/28E14mgFF38r39I5NLes008", "_blank");
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Secure your spot in The Young CFO Weekend with a deposit
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="text-center">
            <p className="text-lg font-semibold mb-2">Deposit: HKD$500</p>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 space-y-2">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>This deposit is non-refundable as it reserves your seat. The remaining balance of HKD$1,500 must be paid on the event day at the venue.</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="space-y-4 text-sm">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>Prices are listed in Hong Kong Dollars (HKD) and are exclusive of applicable taxes, which will be calculated and displayed at checkout.</li>
                        <li>Your seat in the Program is reserved upon receipt of the deposit payment. The remaining balance must be paid on the event day at the venue.</li>
                      </ul>
                    </div>
                    ...
                    <div className="border-t pt-4">
                      ...
                      <ul className="list-disc pl-5 space-y-1">
                        <li>Deposit payments are non-refundable as they reserve your seat in the Program.</li>
                        <li>If the Provider cancels the Program in its entirety, you will receive a full refund of the deposit amount paid.</li>
